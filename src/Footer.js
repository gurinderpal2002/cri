...
const Footer = () => {
    return (
        <div className="footer">
            ...
            <Contact icon={svg2} text={<>Toll free <b>1800 200 1234</b></>} fill={"2"} />
